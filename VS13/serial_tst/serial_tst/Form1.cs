...
namespace GSAD_net_settings
{
    ...
    public partial class Form1 : Form
    {
     ...
     //       public ushort parity;
        ...
        string Module = "Pogodnie roga";    
        public Form1()
        {
            InitializeComponent();
            InitializeComponenthjhkhgh();
            Fill_Com_Ports();
            ...
            //m_mbMaster = ModbusSerialMaster.CreateRtu(SerialPort);
            ...
            SerialPort.PinChanged += new System.IO.Ports.SerialPinChangedEventHandler(this.Serial_Port);
        ...
        private void Fill_Com_Ports()
        {
            ...
            try
            {
                ...
                this.SerialPort.PortName = av_port[COM_sw.SelectedIndex];
        ...
        private void COM_sw_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                this.SerialPort.PortName = av_port[0];
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try {
                ...
                MbMaster = ModbusSerialMaster.CreateRtu(SerialPort);

                ushort[] rBuf = { 200 };
                MbMaster.WriteMultipleRegisters(m_slaveAddr, 1, rBuf);
                System.Threading.Thread.Sleep(200);
                ushort[] tBuf = MbMaster.ReadHoldingRegisters(m_slaveAddr, 0x00, 104);
                int t = 5;
                t++;
            }
            catch(Exception ex)
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ushort[] tmpbuf = MbMaster.ReadHoldingRegisters(0, 0x64, 5);
                Thread.Sleep(200);
                Thread.Sleep(100);
            }
            catch(Exception ex)
        ...
        private void write_btn_Click(object sender, EventArgs e)
        {
            ...
            else if( IsConnected )
            {
                try
                {
                        ...
                        MbMaster.WriteMultipleRegisters((byte)1, 242, SendBuf);
        ...
        private ushort[] pack_mb_msg()
        {
         ...
         //   mb_packet.parity = (ushort)Parity.SelectedIndex;
            ...
            ushort[] Buf = { mb_packet.dev_address , mb_packet.baudrate, mb_packet.stopbit, };
        ...
        private void InitializeComponenthjhkhgh()
        {
            this.SuspendLayout();
            // 
            // Form1
