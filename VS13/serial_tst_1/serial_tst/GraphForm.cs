...
namespace serial_tst
{
    public partial class GraphForm : Form
    {
        ...
        public void DataUpd()
        {
            ...
            {
                case "Temperature":
                    reg_val = (float)USM_Reg.Temperature / 1000f;
                    break;
                case "Humidity":
                    reg_val = (float)USM_Reg.Humidity / 1000f;
                    break;
                case "Pressure":
                ...
                case "WindDir":
                    ...
                    break;
                case "TemperatureAvg":
                    reg_val = (float)USM_Reg.TemperatureAvg / 1000f;
                    break;
                case "HumidityAvg":
                    reg_val = (float)USM_Reg.HumidityAvg / 1000f;
                    break;
                case "PressureAvg":
        ...
        {
            Form f2 = new GSAD_net_settings.Form1();
            f2.Show();
        }
        string[] av_port1;
